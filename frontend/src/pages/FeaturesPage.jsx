        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 pt-20 pb-20">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16 mt-12">
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-[#ff5317] mb-4">
                        Features
                    </h1>
                ...
                <div className="mt-16 text-center">
                    <div className="bg-gradient-to-r from-[#ff5317] to-[#e44b15] rounded-2xl p-8 sm:p-12 text-white shadow-xl">
